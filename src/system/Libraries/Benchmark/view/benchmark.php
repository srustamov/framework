...
<div id="app-benchmark-panel">
    <div id="b-top">
        <p><?php echo http_response_code(); ?></p>
        <span>Time:<?php echo $data['load-time'];
                    unset($data['load-time']); ?></span>
    ...
    <div id="b-bottom">
        ...
        <div class="b-show">
            ...
            <span style="color: tomato;padding: 2px;background: #ffffff;border: 1px solid #04243e;font-weight: bold;">
                <?php echo $data['memory-usage']; ?>
            </span>
        </div>
        <?php unset($data['load-files']);
        unset($data['memory-usage']); ?>
